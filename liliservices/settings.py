"""
Django settings for liliservices project.
...
ROOT_URLCONF = 'liliservices.urls'
...
WSGI_APPLICATION = 'liliservices.wsgi.application'
...
TASK_SLEEP = 10
TASK_TIMEOUT = 10800  # (10800 seconds == 3 hours)
