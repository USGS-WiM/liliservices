# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2018-01-09 16:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('re_rt_note', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pcrreplicates', to='lideservices.PCRReplicate'),
        ),
        migrations.AddField(
            model_name='pcrreplicate',
            name='target',
