# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-11-01 21:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateField(blank=True, db_index=True, default=datetime.date.today, null=True)),
                ('modified_date', models.DateField(auto_now=True, null=True)),
                ('reextraction_note', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('elution_volume', models.FloatField(blank=True, null=True)),
                ('sample_dilution_factor', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analysis_batch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inhibitions', to='lideservices.AnalysisBatch')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', enumchoicefield.fields.EnumChoiceField(enum_class=lideservices.models.NucleicAcidType, max_length=3)),
                ('inhibition_date', models.DateField(blank=True, db_index=True, default=datetime.date.today, null=True)),
                ('analysis_batch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inhibitionbatches', to='lideservices.AnalysisBatch')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='inhibitionbatch_creator', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='inhibitionbatch_modifier', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('replicate_concentration', models.FloatField(blank=True, null=True)),
                ...
                ('replicate_type', enumchoicefield.fields.EnumChoiceField(enum_class=lideservices.models.ReplicateType, max_length=7)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('analysis_batch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reversetranscriptions', to='lideservices.AnalysisBatch')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_volume_or_mass_sampled', models.FloatField(blank=True, null=True)),
        ...
        migrations.AddField(
            model_name='pcrreplicate',
            name='re_pcr',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pcrreplicates', to='lideservices.PCRReplicate'),
        ),
        migrations.AddField(
            model_name='pcrreplicate',
            name='target',
        ...
        migrations.AddField(
            ...
            name='inhibition_batch',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inhibitions', to='lideservices.InhibitionBatch'),
        ),
        migrations.AddField(
            model_name='inhibition',
            name='modified_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='inhibition_modifier', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='inhibition',
            name='sample',
        ...
        migrations.AlterUniqueTogether(
            name='reversetranscription',
            unique_together=set([('analysis_batch', 'rt_number')]),
        ),
        migrations.AlterUniqueTogether(
            name='inhibitionbatch',
            unique_together=set([('analysis_batch', 'inhibition_number')]),
        ),
        migrations.AlterUniqueTogether(
            name='extractionbatch',
