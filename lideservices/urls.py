...
router.register(r'analysisbatchsampleinhibitions', views.AnalysisBatchSampleInhibitionViewSet, 'analysisbatchsampleinhibitions')
...
router.register(r'targetmediums', views.TargetMediumViewSet, 'targetmediums')
