...
router.register(r'sampleenvironments', views.SampleEnvironmentViewSet, 'sampleenvironments')
router.register(r'samplelocations', views.SampleLocationViewSet, 'samplelocations')
router.register(r'filtertypes', views.FilterTypeViewSet, 'filtertypes')
router.register(r'watertypes', views.WaterTypeViewSet, 'watertypes')
